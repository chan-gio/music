    ...
    <img src="<?php echo $imageUrl; ?>" alt="Your Image">
        ...
        <div class="has-subnav">
            <a href="index.php?sort=avatar">
                <div class="Avatar" style="display: flex;flex-direction: row;justify-content: space-between;align-items: center;padding: 16px 24px;gap: 16px;width: 275px;height: 60px;background: #B6B5E3;border-radius: 12px;flex: none;order: 1;align-self: stretch;flex-grow: 0;top: 20px; position:relative;">
